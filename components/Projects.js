      ...
      <div className={styles.projectsContainer}>
            ...
            <div className={styles.textBox} style={boxOneStyle}>
              <div className={styles.content}>
                ...
                <div className={styles.buttons}>
                    ...
                    <a className={styles.buttnBox} target="_blank"><button className={styles.buttnBlue}>GITHUB BACK</button></a>
                    </Link>
                </div>
              </div>
            </div>
              ...
              <div className={styles.content}>
                ...
                <div className={styles.buttons}>
                  <Link href='https://movizz-frontend.vercel.app/'>
                      <a className={styles.buttnBox} target="_blank"><button className={styles.buttnOrange}>LIVE</button></a>
                    </Link>
                    <Link href='https://github.com/clemmory/movizz-frontend/'target="_blank">
                    <a className={styles.buttnBox} target="_blank"><button className={styles.buttnOrange}>GITHUB FRONT</button></a>
                    </Link>
                    <Link href='https://github.com/clemmory/movizz-backend/'target="_blank">
                    <a className={styles.buttnBox} target="_blank"><button className={styles.buttnOrange}>GITHUB BACK</button></a>
                    </Link>
                </div>
              </div>
            </div>
        ...
        <div className={styles.textBox} style={boxThreeStyle}>
          <div className={styles.content}>
                ...
                <div className={styles.buttons}>
                  <Link href='https://movizz-frontend.vercel.app/'>
                    <a className={styles.buttnBox} target="_blank"><button className={styles.buttnGreen}>LIVE</button></a>
                  </Link>
                  <Link href='https://github.com/clemmory/movizz-frontend/'target="_blank">
                  <a className={styles.buttnBox} target="_blank"><button className={styles.buttnGreen}>GITHUB FRONT</button></a>
                  </Link>
                  <Link href='https://github.com/clemmory/movizz-backend/'target="_blank">
                  <a className={styles.buttnBox} target="_blank"><button className={styles.buttnGreen}>GITHUB BACK</button></a>
                  </Link>
                </div>
              </div>
            </div>
